...
public class test {
    ...
    public void breakVigenere () {
        FileResource fr2 = new FileResource("E:/Coursera Java/3.Java - Arrays, Lists, and Structured Data/Project/Week4-Breaking the Vigenère Cipher/VigenereProgram/dictionaries/English");
    	...
    	int num = countWords(decrypt, dictionary);
