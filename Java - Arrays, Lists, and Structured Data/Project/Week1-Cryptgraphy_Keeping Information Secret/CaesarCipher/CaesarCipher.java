...
/**
 * Assignment week1-2:Caesar Cipher
 * 
 * @作者（你的名字）
 * @版本（一个版本号或者一个日期）
 */
...
public class CaesarCipher{
    public String encrypt(String input,int key,int k){//int k startpoint
        ...
        int i=0;
        for (i=k ; i<input.length() ; i=i+1){ //+1 for part1,I+2 for part2
    ...
    public String encryptTwoKeys(String input,int key1,int key2){
        StringBuilder inputsb = new StringBuilder(input);
        StringBuilder encryptkey1 = new StringBuilder(encrypt(input,key1,0));
        StringBuilder encryptkey2 = new StringBuilder(encrypt(input,key2,1));
        int i=0;
